...
public interface ImageColorCodeRepository extends GraphRepository<ImageColorCode> {
	...
	@Query("match (icc:ImageColorCode) where icc.id = {idImageColorCode} and icc.isDeleted = 0 return icc.imageColorCode")
	String getImageColorCode(@Param("idImageColorCode") Long idImageColorCode);
