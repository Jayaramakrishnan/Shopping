...
public class PhoneNumberTranslator {
	...
	public PhoneNumber translateDtoToPhoneNumber(PhoneNumberDto phoneNumberDto) throws InvocationTargetException {
		...
		phoneNumber.setId(phoneTypeTranslator.getPhoneTypeId(phoneNumberDto.getPhoneTypeDto()));
		return phoneNumber;
	}

	public Long getPhoneNumberId(PhoneNumberDto phoneNumberDto) {
		if (phoneNumberDto == null) {
			return null;
		}
		return phoneNumberDto.getId();
	}

	public PhoneNumberDto translateToPhoneNumberDto(Long idPhoneNumber) throws InvocationTargetException {
		if (idPhoneNumber == null) {
			return null;
		}
		PhoneNumberDto phoneNumberDto = new PhoneNumberDto();
		phoneNumberDto.setId(idPhoneNumber);
		return phoneNumberDto;
	}
}