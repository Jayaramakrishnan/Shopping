...
public class CommonConstants {
	...
	public static final String										UNAUTHORIZEDMSG			= "Unauthorized";
	public static final String										RESPONSESTATUSMSG		= "response status: ";
	public static final String										RESPONSEURIMSG			= "response uri: ";
}