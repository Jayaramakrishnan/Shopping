...
libraryDependencies ++= Seq(
  ...
  "org.springframework.data" % "spring-data-neo4j" % "4.0.0.RELEASE" exclude("org.neo4j","neo4j-cypher-dsl"),
  "org.neo4j" % "neo4j" % "3.0.7",
  "org.springframework.data" % "spring-data-commons-core" % "1.3.2.RELEASE",
